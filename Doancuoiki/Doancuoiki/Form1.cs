...
namespace Doancuoiki
{
    public partial class Form1 : Form
    {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
           ...
           // MessageBox.Show(len.ToString());
            ...
            if (n==0)
            {
                ...
                MessageBox.Show("Lỗi hệ thống nhập!");
                gotoclear();
                return;
            }
            for (int i = 1; i <= n; i++)
        ...
        void paintwayarrow(int[] ktra)
        {
            ...
            foreach (var i in line) // vẻ cái node cho sáng
            {
        ...
        private void matrix_SelectedIndexChanged(object sender, EventArgs e)
        {
